...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TubePilot — YouTube channel management" },
      {
        name: "description",
        content:
          "TubePilot is a professional console for managing YouTube channels: upload, schedule, edit metadata and track analytics.",
      },
      { property: "og:title", content: "TubePilot — YouTube channel management" },
      {
